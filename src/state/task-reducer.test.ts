...
test("change checkbox in correct task of correct todolist", () => {
    ...
    const endState = taskReducer(startState, CheckboxChangeAC(TodolistID1, startState[TodolistID1][2].id))
...
test("change tasks title in correct todolist", () => {
    ...
    const endState = taskReducer(startState, ChangeTaskTitleAC(TodolistID1, startState[TodolistID1][0].id, "NewTestTitle"))
